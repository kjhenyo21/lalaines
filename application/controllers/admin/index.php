...
class Index extends CI_Controller {
	...
	public function index() {
		...
		if ($this->session->userdata('status') != 'authorizedAdmin') {
			header("location:".$this->config->item('base_url')."index?status=unauthorizedAccess");
		}
		else {
	...
	public function searchCustomerInvoice() {
		...
		header("location: ".$this->config->item('base_url')."admin/invoice?customer=".$cust_no."&invoice=".$temp_inv_no);
	}
