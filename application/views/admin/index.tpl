	...
	<body>
		...
		<div id="audit_trail" class="modal hide fade" style="margin-top: auto; width: 480px">
			...
			<div class="modal-body">
				<form method="post" action="{url}audit_trail/index/readFile">
					<fieldset>
		...
		<!-- Main -->
		<h3 style="margin: 20px auto; text-align: center"> Dashboard </h3>
		<div id="main-wrapper" style="width: 300px">
			<div style="margin: 0 auto; text-align: center">
				<a href="cashier" role="button" class="btn" style="width: 190px">Cashier</a>
				<br><a href="#audit_trail" role="button" class="btn" data-toggle="modal" style="width: 190px">Audit Trail</a>
			</div>
		</div>
		<div id="footer">
